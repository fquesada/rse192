...
$databasename       =   'autodiagnostico192';  // The name of the database that we will create
$databaseuser       =   'lime192';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'lime192';            // Password of db user
$dbprefix           =   '';       // A global prefix that can be added to all LimeSurvey tables. Use this if you are sharing
// a database with other applications. Suggested prefix is 'lime_'

// File Locations
$rooturl            =   "http://{$_SERVER['HTTP_HOST']}/autodiagnostico192/limesurvey"; // The root web url for your limesurvey installation (without a trailing slash).
